...
class Client : SubjectAccessor
{
    static void Main()
    {
        ...
        ProtectionProxy _subject = new ProtectionProxy();
        Console.WriteLine(_subject.Request());
        Console.WriteLine((_subject as ProtectionProxy).Authenticate("Secret"));
        Console.WriteLine((_subject as ProtectionProxy).Authenticate("Abracadabra"));
        Console.WriteLine(_subject.Request());
    }
}